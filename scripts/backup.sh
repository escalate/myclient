...
DATE=$(date +%Y_%m_%d)
DIRS_TO_TAR=( "${HOME}/Documents/workspace/private" "${HOME}/Documents/workspace/work" "${HOME}/Downloads" "${HOME}/Desktop" "${HOME}/Pictures" "${HOME}/.local/share/Trash" "${HOME}/.purple" "${HOME}/secrets" "/etc" )
